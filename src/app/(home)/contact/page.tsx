      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="p-6 bg-muted rounded-xl">
            ...
            <p className="text-muted-foreground">{profile.social.location}</p>
          </div>

          <ContactCard
            title="Contact me"
            href={`mailto:${profile.social.email}?subject=Contact%20from%20Portfolio`}
        ...
        <div className="bg-muted rounded-xl p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Button
                size="lg"
                className="bg-primary text-white dark:text-black hover:opacity-90 transition-opacity w-full sm:w-auto"
              >
